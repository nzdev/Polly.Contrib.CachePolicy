...
namespace Polly.Contrib.CachePolicy.Providers.Logging
{
    ...
    public interface ILoggingProvider
    {
        ...
        void OnCacheGet(string key, bool isSuccess, bool isCacheHit, bool isCacheFresh, long latencyInMilliSeconds, Exception failureException, ResilienceContext context);
        ...
        /// <param name="context">The execution context.</param>
        void OnCacheSet(string key, bool isSuccess, long latencyInMilliSeconds, Exception failureException, ResilienceContext context);
        ...
        /// <param name="context">The execution context.</param>
        void OnBackendGet<TResult>(string key, bool isSuccess, bool isFallbackToCache, long latencyInMilliSeconds, DelegateResult<TResult> delegateFailureOutcome, ResilienceContext context)
        ...
        /// <param name="context">The execution context.</param>
        void OnCacheSerialize(string key, string serializationStrategy, long latencyInMilliSeconds, long serializedSize, ResilienceContext context);
        ...
        /// <param name="latencyInMilliSeconds">The overall latency for a single operation to fetch result from backend services with the option to fall back to cache.</param>
        /// <param name="context">The execution context.</param>
        void OnCacheDeserialize(string key, string serializationStrategy, long latencyInMilliSeconds, ResilienceContext context);
        ...
        /// <param name="context">The execution context.</param>
        void OnCacheCompress(string key, string compressionStrategy, long latencyInMilliSeconds, long compressedSize, ResilienceContext context);
        ...
        /// <param name="latencyInMilliSeconds">The overall latency for a single operation to fetch result from backend services with the option to fall back to cache.</param>
        /// <param name="context">The execution context.</param>
        void OnCacheDecompress(string key, string compressionStrategy, long latencyInMilliSeconds, ResilienceContext context);
    }
}
